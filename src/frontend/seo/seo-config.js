...
// Phase 12 provides a real application journey for genuine published vacancies.
// Runtime job-detail pages may therefore be indexed and emit JobPosting data.
export const JOB_SEARCH_INDEXING_ENABLED = true;
