...
function securityActivity(
  ...
  return `<section class="activity-plane" aria-labelledby="activity-title"><header class="section-header"><div><h2 id="activity-title">Security activity</h2><p>Server-authorized, redacted and append-only audit visibility. Raw IP hashes, user agents, metadata, before/after JSON, full internal UUIDs, message bodies and document content are never projected.</p></div><span class="section-meta">Page ${context.page} of max ${context.max_page} · 25 rows</span></header>
